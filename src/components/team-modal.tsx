...
export function TeamModal({ onSuccess }: TeamModalProps) {
  ...
  const teamData = isEdit ? (modalData as { id: number; name: string; description?: string; leadId?: number }) : null;
        ...
        <DialogContent className="sm:max-w-[425px]">
          ...
          <form ref={formRef} action={formAction} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select name="leadId" defaultValue={isEdit ? teamData?.leadId?.toString() || "0" : "0"}>
                <SelectTrigger className={state.errors?.leadId ? 'border-red-500' : ''}>
